 ...
 * Approximately 2% of clicks deliberately miss and self-correct (misclick sim).
 *
 * Ported from the monolith src/main/java/com/botengine/osrs/util/Mouse.java
 * into axiom-plugin/util/ with package updated. Logic unchanged.
 */
@Slf4j
@Singleton
public class Mouse
{
    ...
    public Mouse(Client client, Antiban antiban)
    {
        ...
        {
            log.error("Mouse: failed to create java.awt.Robot — actor click movement disabled: {}", e.getMessage());
        }
    }
